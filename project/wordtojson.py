    ...
    for index, row in enumerate(table.rows):
        ...
        for industry in industry_list:
            ...
            if type_name == "农业分管负责人":
                ...
                data[name_key] = cells[1].text
                data[tel_key] = cells[2].text
            elif type_name == "水产业分管负责人":
                type_name = "aquatic_owner"
                name_key = "aquatic_owner_name"
                tel_key = "aquatic_owner_tel"
                data[name_key] = cells[3].text
                data[tel_key] = cells[4].text
    ...
    for index, row in enumerate(table.rows):
        ...
        for industry in industry_list:
            ...
            if type_name == "分管负责人":
                ...
                data[name_key] = cells[1].text
                data[title_key] = cells[2].text
                data[tel_key] = cells[3].text
                data[mobile_key] = cells[4].text
                ...
                data[name_key] = cells[5].text
                data[title_key] = cells[6].text
                data[tel_key] = cells[7].text
                data[mobile_key] = cells[8].text
